...
public class ConverterConfiguration {
    ...
    private void processClass(Class<?> clazz) {
        if (clazz.isAnnotationPresent(Type.class)) {
            ...
            List<Field> linkFields = ReflectionUtils.getAnnotatedFields(clazz,
                    com.spheremall.core.jsonapi.annotations.Links.class, true);
     ...
     * </p>
     *
     * @param field {@link Field} to data relationship for
     ...
     *
     * @param clazz {@link Class} to data relationship fields for
