...
public class AttributesResourceImpl extends BaseResource<Attribute, AttributesResource> implements AttributesResource {
    ...
    @Override
    public Response<List<Attribute>> belong(Class entityClass) throws EntityNotFoundException, IOException, ServiceException {
    ...
    @Override
    public Response<List<Attribute>> belong(Class entityClass, int groupId) throws EntityNotFoundException, IOException, ServiceException {
        String className = entityClass.getSimpleName().toLowerCase();
    ...
    @Override
    public Response<Attribute> belong(Class entityClass, int groupId, int attributeId) throws EntityNotFoundException, IOException, ServiceException {
        String className = entityClass.getSimpleName().toLowerCase();
