...
public class BasketResourceImpl extends BaseResource<BasketOrder, BasketResource> implements BasketResource {
    ...
    @Override
    public Response<BasketOrder> get(int id) throws ServiceException, IOException, EntityNotFoundException {
    ...
    @Override
    public Response<BasketOrder> update(Integer id, HashMap<String, String> params) throws EntityNotFoundException, IOException, ServiceException {
    ...
    @Override
    public BasketOrder removeItems(HashMap<String, String> data) throws EntityNotFoundException, IOException, ServiceException {
